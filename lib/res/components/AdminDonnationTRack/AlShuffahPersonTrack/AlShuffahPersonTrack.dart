...
class AlShuffahPersonTrackForAdmin extends StatelessWidget {
  ...
  final IconData icon;
  const AlShuffahPersonTrackForAdmin(
      {super.key,
      ...
      required this.onshopClick, required this.personname, required this.icon});
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Visibility(
                      visible: recivedDonnation == price ? true : false,
